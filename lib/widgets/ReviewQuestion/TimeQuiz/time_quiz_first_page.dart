...
class TimeQuizFirstPage extends StatefulWidget {
  const TimeQuizFirstPage({super.key});

  @override
  State<TimeQuizFirstPage> createState() => _QuestionPage1State();
}

class _QuestionPage1State extends State<TimeQuizFirstPage> {
            ...
            children: [
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.pushNamed(context, "/TimeQuizSecondPage");
                    },
                    style: ElevatedButton.styleFrom(
